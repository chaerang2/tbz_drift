  ...
  return (
    <div className='contents_box'>
      ...
      <div className='information'>
        ...
        <p>이제는 성장을 마친 단단한 소년의 마음을 가지고 있는 것 같았던 더보이즈 사랑하는 사람 앞에서는 약해지게되는 아련하고 로맨틱하게 변신하는 앨범으로 돌아왔다. 날 사랑하지 않는 사람을 사랑하는 것을 마치 섬에 표류한 한 소년처럼 하염없이 바라보는 것을 표현한다. 더스틸러에서 네 심장을 움켜쥔다며 자신만만하던 소년이 사랑하는 사람을 만나 변하는 모습을 볼 수 있을 것으로 기대가 된다.</p>
        <p>
          [TRACKLIST] <br /><br />
          1. Blessing or Punishment _ intro 곡으로, 상대를 알게 된 것이 축복인지 벌인지 혼란스러워하며 하는 혼잣말을 내레이션으로 풀어낸 곡이다. <br /> <br />
          2. In Sum _ 짝사랑하는 소년의 관점에서 풀어낸 곡으로, '네가 내 불면이라면 기꺼이 밤을 새우리'라는 가사로 상대를 향한 강한 사랑이 느껴지는 곡이다. 불면증으로 인해 현실과 꿈이 구분이 안가는듯한 느낌을 주는 몽환적인 멜로디가 베이스를 꽉채운다. <br /> <br />
